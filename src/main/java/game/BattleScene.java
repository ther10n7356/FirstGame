...
import game.io.AbstractCharacter;
import game.io.Hero;

public class BattleScene {
    public void fight(AbstractCharacter hero, AbstractCharacter monster, FightCallback fightCallback) {
        Runnable runnable = () -> {
            int turn = 1;
    ...
    private Boolean makeHit(AbstractCharacter defender, AbstractCharacter attacker, FightCallback fightCallback) {
